...
const socials = [
  {
    label: "LinkedIn",
    href: "https://linkedin.com/in/your-profile", // ← paste your LinkedIn URL here
    icon: (
  ...
  {
    label: "Instagram",
    href: "https://instagram.com/your-profile", // ← paste your Instagram URL here
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
  ...
  {
    label: "X",
    href: "https://x.com/your-profile", // ← paste your X (Twitter) URL here
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
            ...
            <div className="flex gap-3 pt-1">
              {socials.map((s) => (
                <a
                  ...
                  aria-label={s.label}
                  className="w-10 h-10 rounded-full border border-gold/25 flex items-center justify-center text-gold/70 hover:text-navy-dark hover:bg-gold hover:border-gold transition-all duration-300 group"
                >
                  {s.icon}
                </a>
              ))}
